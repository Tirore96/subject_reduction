...
Inductive gType  : Set :=
  ...
  | GBranch : action -> seq (nat * gType) -> gType  
 with value  : Set  :=
  | VSort : mysort -> value  
 ...
 with lType  : Set :=
  ...
  | EBranch  : dir -> ch  -> seq (nat * lType) -> lType  
  | ERec : lType -> lType . 
...
Lemma congr_SGType  { s0 : gType   } { t0 : gType   } (H1 : s0 = t0) : SGType s0 = SGType t0 .
Proof. congruence. Qed.
...
Lemma congr_VSort  { s0 : mysort   } { t0 : mysort   } (H1 : s0 = t0) : VSort s0 = VSort t0 .
Proof. congruence. Qed.

Lemma congr_VLT  { s0 : lType   } { s1 : ptcp   } { t0 : lType   } { t1 : ptcp   } (H1 : s0 = t0) (H2 : s1 = t1) : VLT s0 s1 = VLT t0 t1 .
Proof. congruence. Qed.
...
Lemma congr_EBranch  { s0 : dir   } { s1 : ch   } { s2 : list (prod (nat  ) (lType  )) } { t0 : dir   } { t1 : ch   } { t2 : list (prod (nat  ) (lType  )) } (H1 : s0 = t0) (H2 : s1 = t1) (H3 : s2 = t2) : EBranch  s0 s1 s2 = EBranch  t0 t1 t2 .
Proof. congruence. Qed.
...
Fixpoint ren_lType   (xilType : ( fin ) -> fin) (s : lType ) : lType  :=
    ...
    | EBranch  s0 s1 s2 => EBranch  ((fun x => x) s0) ((fun x => x) s1) ((map (prod_map (fun x => x) (ren_lType xilType))) s2)
    end.
...
Fixpoint subst_lType   (sigmalType : ( fin ) -> lType ) (s : lType ) : lType  :=
    ...
    | EBranch  s0 s1 s2 => EBranch  ((fun x => x) s0) ((fun x => x) s1) ((map (prod_map (fun x => x) (subst_lType sigmalType))) s2)
    end.
...
Fixpoint idSubst_lType  (sigmalType : ( fin ) -> lType ) (EqlType : forall x, sigmalType x = (EVar ) x) (s : lType ) : subst_lType sigmalType s = s :=
    ...
    | EBranch  s0 s1 s2 => congr_EBranch ((fun x => (Logic.eq_refl) x) s0) ((fun x => (Logic.eq_refl) x) s1) ((seq_id (prod_id (fun x => (Logic.eq_refl) x) (idSubst_lType sigmalType EqlType))) s2)
    end.
...
Fixpoint extRen_lType   (xilType : ( fin ) -> fin) (zetalType : ( fin ) -> fin) (EqlType : forall x, xilType x = zetalType x) (s : lType ) : ren_lType xilType s = ren_lType zetalType s :=
    ...
    | EBranch  s0 s1 s2 => congr_EBranch ((fun x => (Logic.eq_refl) x) s0) ((fun x => (Logic.eq_refl) x) s1) ((seq_ext (prod_ext (fun x => (Logic.eq_refl) x) (extRen_lType xilType zetalType EqlType))) s2)
    end.
...
Fixpoint ext_lType   (sigmalType : ( fin ) -> lType ) (taulType : ( fin ) -> lType ) (EqlType : forall x, sigmalType x = taulType x) (s : lType ) : subst_lType sigmalType s = subst_lType taulType s :=
    ...
    | EBranch  s0 s1 s2 => congr_EBranch ((fun x => (Logic.eq_refl) x) s0) ((fun x => (Logic.eq_refl) x) s1) ((seq_ext (prod_ext (fun x => (Logic.eq_refl) x) (ext_lType sigmalType taulType EqlType))) s2)
    end.
...
Fixpoint compRenRen_lType    (xilType : ( fin ) -> fin) (zetalType : ( fin ) -> fin) (rholType : ( fin ) -> fin) (EqlType : forall x, ((funcomp) zetalType xilType) x = rholType x) (s : lType ) : ren_lType zetalType (ren_lType xilType s) = ren_lType rholType s :=
    ...
    | EBranch  s0 s1 s2 => congr_EBranch ((fun x => (Logic.eq_refl) x) s0) ((fun x => (Logic.eq_refl) x) s1) ((seq_comp (prod_comp (fun x => (Logic.eq_refl) x) (compRenRen_lType xilType zetalType rholType EqlType))) s2)
    end.
...
Fixpoint compRenSubst_lType    (xilType : ( fin ) -> fin) (taulType : ( fin ) -> lType ) (thetalType : ( fin ) -> lType ) (EqlType : forall x, ((funcomp) taulType xilType) x = thetalType x) (s : lType ) : subst_lType taulType (ren_lType xilType s) = subst_lType thetalType s :=
    ...
    | EBranch  s0 s1 s2 => congr_EBranch ((fun x => (Logic.eq_refl) x) s0) ((fun x => (Logic.eq_refl) x) s1) ((seq_comp (prod_comp (fun x => (Logic.eq_refl) x) (compRenSubst_lType xilType taulType thetalType EqlType))) s2)
    end.

Definition up_subst_ren_lType_lType    (sigma : ( fin ) -> lType ) (zetalType : ( fin ) -> fin) (theta : ( fin ) -> lType ) (Eq : forall x, ((funcomp) (ren_lType zetalType) sigma) x = theta x) : forall x, ((funcomp) (ren_lType (upRen_lType_lType zetalType)) (up_lType_lType sigma)) x = (up_lType_lType theta) x :=
  fun n => match n with
  | S fin_n => (Logic.eq_trans) (compRenRen_lType (shift) (upRen_lType_lType zetalType) ((funcomp) (shift) zetalType) (fun x => Logic.eq_refl) (sigma fin_n)) ((Logic.eq_trans) ((Logic.eq_sym) (compRenRen_lType zetalType (shift) ((funcomp) (shift) zetalType) (fun x => Logic.eq_refl) (sigma fin_n))) ((ap) (ren_lType (shift)) (Eq fin_n)))
  | 0  => Logic.eq_refl
  end.
...
Fixpoint compSubstRen_lType    (sigmalType : ( fin ) -> lType ) (zetalType : ( fin ) -> fin) (thetalType : ( fin ) -> lType ) (EqlType : forall x, ((funcomp) (ren_lType zetalType) sigmalType) x = thetalType x) (s : lType ) : ren_lType zetalType (subst_lType sigmalType s) = subst_lType thetalType s :=
    ...
    | EBranch  s0 s1 s2 => congr_EBranch ((fun x => (Logic.eq_refl) x) s0) ((fun x => (Logic.eq_refl) x) s1) ((seq_comp (prod_comp (fun x => (Logic.eq_refl) x) (compSubstRen_lType sigmalType zetalType thetalType EqlType))) s2)
    end.
...
Definition up_subst_subst_lType_lType    (sigma : ( fin ) -> lType ) (taulType : ( fin ) -> lType ) (theta : ( fin ) -> lType ) (Eq : forall x, ((funcomp) (subst_lType taulType) sigma) x = theta x) : forall x, ((funcomp) (subst_lType (up_lType_lType taulType)) (up_lType_lType sigma)) x = (up_lType_lType theta) x :=
  fun n => match n with
  | S fin_n => (Logic.eq_trans) (compRenSubst_lType (shift) (up_lType_lType taulType) ((funcomp) (up_lType_lType taulType) (shift)) (fun x => Logic.eq_refl) (sigma fin_n)) ((Logic.eq_trans) ((Logic.eq_sym) (compSubstRen_lType taulType (shift) ((funcomp) (ren_lType (shift)) taulType) (fun x => Logic.eq_refl) (sigma fin_n))) ((ap) (ren_lType (shift)) (Eq fin_n)))
  | 0  => Logic.eq_refl
  end.
...
Fixpoint compSubstSubst_lType    (sigmalType : ( fin ) -> lType ) (taulType : ( fin ) -> lType ) (thetalType : ( fin ) -> lType ) (EqlType : forall x, ((funcomp) (subst_lType taulType) sigmalType) x = thetalType x) (s : lType ) : subst_lType taulType (subst_lType sigmalType s) = subst_lType thetalType s :=
    ...
    | EBranch  s0 s1 s2 => congr_EBranch ((fun x => (Logic.eq_refl) x) s0) ((fun x => (Logic.eq_refl) x) s1) ((seq_comp (prod_comp (fun x => (Logic.eq_refl) x) (compSubstSubst_lType sigmalType taulType thetalType EqlType))) s2)
    end.
...
Fixpoint rinst_inst_lType   (xilType : ( fin ) -> fin) (sigmalType : ( fin ) -> lType ) (EqlType : forall x, ((funcomp) (EVar ) xilType) x = sigmalType x) (s : lType ) : ren_lType xilType s = subst_lType sigmalType s :=
    ...
    | EBranch  s0 s1 s2 => congr_EBranch ((fun x => (Logic.eq_refl) x) s0) ((fun x => (Logic.eq_refl) x) s1) ((seq_ext (prod_ext (fun x => (Logic.eq_refl) x) (rinst_inst_lType xilType sigmalType EqlType))) s2)
    end.
...
Proof. exact ((Logic.eq_trans) (rinstInst_lType ((id) (_))) instId_lType). Qed.
...
Lemma congr_GBranch  { s0 : action   } { s1 : list (prod (nat  ) (gType  )) } { t0 : action   } { t1 : list (prod (nat  ) (gType  )) } (H1 : s0 = t0) (H2 : s1 = t1) : GBranch  s0 s1 = GBranch  t0 t1 .
Proof. congruence. Qed.
...
Fixpoint ren_gType   (xigType : ( fin ) -> fin) (s : gType ) : gType  :=
    ...
    | GBranch  s0 s1 => GBranch  ((fun x => x) s0) ((map (prod_map (fun x => x) (ren_gType xigType))) s1)
    end.
...
Fixpoint subst_gType   (sigmagType : ( fin ) -> gType ) (s : gType ) : gType  :=
    ...
    | GBranch  s0 s1 => GBranch  ((fun x => x) s0) ((map (prod_map (fun x => x) (subst_gType sigmagType))) s1)
    end.
...
Fixpoint idSubst_gType  (sigmagType : ( fin ) -> gType ) (EqgType : forall x, sigmagType x = (GVar ) x) (s : gType ) : subst_gType sigmagType s = s :=
    ...
    | GBranch  s0 s1 => congr_GBranch ((fun x => (Logic.eq_refl) x) s0) ((seq_id (prod_id (fun x => (Logic.eq_refl) x) (idSubst_gType sigmagType EqgType))) s1)
    end.
...
Fixpoint extRen_gType   (xigType : ( fin ) -> fin) (zetagType : ( fin ) -> fin) (EqgType : forall x, xigType x = zetagType x) (s : gType ) : ren_gType xigType s = ren_gType zetagType s :=
    ...
    | GBranch  s0 s1 => congr_GBranch ((fun x => (Logic.eq_refl) x) s0) ((seq_ext (prod_ext (fun x => (Logic.eq_refl) x) (extRen_gType xigType zetagType EqgType))) s1)
    end.
...
Fixpoint ext_gType   (sigmagType : ( fin ) -> gType ) (taugType : ( fin ) -> gType ) (EqgType : forall x, sigmagType x = taugType x) (s : gType ) : subst_gType sigmagType s = subst_gType taugType s :=
    ...
    | GBranch  s0 s1 => congr_GBranch ((fun x => (Logic.eq_refl) x) s0) ((seq_ext (prod_ext (fun x => (Logic.eq_refl) x) (ext_gType sigmagType taugType EqgType))) s1)
    end.
...
Fixpoint compRenRen_gType    (xigType : ( fin ) -> fin) (zetagType : ( fin ) -> fin) (rhogType : ( fin ) -> fin) (EqgType : forall x, ((funcomp) zetagType xigType) x = rhogType x) (s : gType ) : ren_gType zetagType (ren_gType xigType s) = ren_gType rhogType s :=
    ...
    | GBranch  s0 s1 => congr_GBranch ((fun x => (Logic.eq_refl) x) s0) ((seq_comp (prod_comp (fun x => (Logic.eq_refl) x) (compRenRen_gType xigType zetagType rhogType EqgType))) s1)
    end.
...
Fixpoint compRenSubst_gType    (xigType : ( fin ) -> fin) (taugType : ( fin ) -> gType ) (thetagType : ( fin ) -> gType ) (EqgType : forall x, ((funcomp) taugType xigType) x = thetagType x) (s : gType ) : subst_gType taugType (ren_gType xigType s) = subst_gType thetagType s :=
    ...
    | GBranch  s0 s1 => congr_GBranch ((fun x => (Logic.eq_refl) x) s0) ((seq_comp (prod_comp (fun x => (Logic.eq_refl) x) (compRenSubst_gType xigType taugType thetagType EqgType))) s1)
    end.
...
Definition up_subst_ren_gType_gType    (sigma : ( fin ) -> gType ) (zetagType : ( fin ) -> fin) (theta : ( fin ) -> gType ) (Eq : forall x, ((funcomp) (ren_gType zetagType) sigma) x = theta x) : forall x, ((funcomp) (ren_gType (upRen_gType_gType zetagType)) (up_gType_gType sigma)) x = (up_gType_gType theta) x :=
  fun n => match n with
  | S fin_n => (Logic.eq_trans) (compRenRen_gType (shift) (upRen_gType_gType zetagType) ((funcomp) (shift) zetagType) (fun x => Logic.eq_refl) (sigma fin_n)) ((Logic.eq_trans) ((Logic.eq_sym) (compRenRen_gType zetagType (shift) ((funcomp) (shift) zetagType) (fun x => Logic.eq_refl) (sigma fin_n))) ((ap) (ren_gType (shift)) (Eq fin_n)))
  | 0  => Logic.eq_refl
  end.
...
Fixpoint compSubstRen_gType    (sigmagType : ( fin ) -> gType ) (zetagType : ( fin ) -> fin) (thetagType : ( fin ) -> gType ) (EqgType : forall x, ((funcomp) (ren_gType zetagType) sigmagType) x = thetagType x) (s : gType ) : ren_gType zetagType (subst_gType sigmagType s) = subst_gType thetagType s :=
    ...
    | GBranch  s0 s1 => congr_GBranch ((fun x => (Logic.eq_refl) x) s0) ((seq_comp (prod_comp (fun x => (Logic.eq_refl) x) (compSubstRen_gType sigmagType zetagType thetagType EqgType))) s1)
    end.
...
Definition up_subst_subst_gType_gType    (sigma : ( fin ) -> gType ) (taugType : ( fin ) -> gType ) (theta : ( fin ) -> gType ) (Eq : forall x, ((funcomp) (subst_gType taugType) sigma) x = theta x) : forall x, ((funcomp) (subst_gType (up_gType_gType taugType)) (up_gType_gType sigma)) x = (up_gType_gType theta) x :=
  fun n => match n with
  | S fin_n => (Logic.eq_trans) (compRenSubst_gType (shift) (up_gType_gType taugType) ((funcomp) (up_gType_gType taugType) (shift)) (fun x => Logic.eq_refl) (sigma fin_n)) ((Logic.eq_trans) ((Logic.eq_sym) (compSubstRen_gType taugType (shift) ((funcomp) (ren_gType (shift)) taugType) (fun x => Logic.eq_refl) (sigma fin_n))) ((ap) (ren_gType (shift)) (Eq fin_n)))
  | 0  => Logic.eq_refl
  end.
...
Fixpoint compSubstSubst_gType    (sigmagType : ( fin ) -> gType ) (taugType : ( fin ) -> gType ) (thetagType : ( fin ) -> gType ) (EqgType : forall x, ((funcomp) (subst_gType taugType) sigmagType) x = thetagType x) (s : gType ) : subst_gType taugType (subst_gType sigmagType s) = subst_gType thetagType s :=
    ...
    | GBranch  s0 s1 => congr_GBranch ((fun x => (Logic.eq_refl) x) s0) ((seq_comp (prod_comp (fun x => (Logic.eq_refl) x) (compSubstSubst_gType sigmagType taugType thetagType EqgType))) s1)
    end.
...
Fixpoint rinst_inst_gType   (xigType : ( fin ) -> fin) (sigmagType : ( fin ) -> gType ) (EqgType : forall x, ((funcomp) (GVar ) xigType) x = sigmagType x) (s : gType ) : ren_gType xigType s = subst_gType sigmagType s :=
    ...
    | GBranch  s0 s1 => congr_GBranch ((fun x => (Logic.eq_refl) x) s0) ((seq_ext (prod_ext (fun x => (Logic.eq_refl) x) (rinst_inst_gType xigType sigmagType EqgType))) s1)
    end.
...
Proof. exact ((Logic.eq_trans) (rinstInst_gType ((id) (_))) instId_gType). Qed.
...
Notation "x '__lType'" := (@ids (_) (_) VarInstance_lType x) (at level 5, only printing, format "x __lType") : subst_scope.

Notation "'var'" := (EVar) (only printing, at level 1) : subst_scope.

Global Instance VarInstance_gType  : Var (fin) (gType ) := @GVar  .

Notation "x '__gType'" := (GVar x) (at level 5, format "x __gType") : subst_scope.

Notation "x '__gType'" := (@ids (_) (_) VarInstance_gType x) (at level 5, only printing, format "x __gType") : subst_scope.

Notation "'var'" := (GVar) (only printing, at level 1) : subst_scope.

Class Up_lType X Y := up_lType : ( X ) -> Y.

Notation "↑__lType" := (up_lType) (only printing) : subst_scope.

Class Up_gType X Y := up_gType : ( X ) -> Y.

Notation "↑__gType" := (up_gType) (only printing) : subst_scope.

Notation "↑__lType" := (up_lType_lType) (only printing) : subst_scope.

Global Instance Up_lType_lType   : Up_lType (_) (_) := @up_lType_lType   .

Notation "↑__gType" := (up_gType_gType) (only printing) : subst_scope.
...
(*Notation "s [e sigmalType ]" := (subst_lType sigmalType s) (at level 7, left associativity, only printing) : subst_scope.

Notation "[e sigmalType ]" := (subst_lType sigmalType) (at level 1, left associativity, only printing) : fscope.

Notation "s ⟨e xilType ⟩" := (ren_lType xilType s) (at level 7, left associativity, only printing) : subst_scope.

Notation "⟨e xilType ⟩" := (ren_lType xilType) (at level 1, left associativity, only printing) : fscope.

Notation "s [g sigmagType ]" := (subst_gType sigmagType s) (at level 7, left associativity, only printing) : subst_scope.

Notation "[g sigmagType ]" := (subst_gType sigmagType) (at level 1, left associativity, only printing) : fscope.

Notation "s ⟨g xigType ⟩" := (ren_gType xigType s) (at level 7, left associativity, only printing) : subst_scope.

Notation "⟨g xigType ⟩" := (ren_gType xigType) (at level 1, left associativity, only printing) : fscope.*)
...
Tactic Notation "asimpl" "in" "*" := auto_unfold in *; repeat first [progress rewrite ?instId_lType in *| progress rewrite ?compComp_lType in *| progress rewrite ?compComp'_lType in *| progress rewrite ?instId_gType in *| progress rewrite ?compComp_gType in *| progress rewrite ?compComp'_gType in *| progress rewrite ?rinstId_lType in *| progress rewrite ?compRen_lType in *| progress rewrite ?compRen'_lType in *| progress rewrite ?renComp_lType in *| progress rewrite ?renComp'_lType in *| progress rewrite ?renRen_lType in *| progress rewrite ?renRen'_lType in *| progress rewrite ?rinstId_gType in *| progress rewrite ?compRen_gType in *| progress rewrite ?compRen'_gType in *| progress rewrite ?renComp_gType in *| progress rewrite ?renComp'_gType in *| progress rewrite ?renRen_gType in *| progress rewrite ?renRen'_gType in *| progress rewrite ?varL_lType in *| progress rewrite ?varL_gType in *| progress rewrite ?varLRen_lType in *| progress rewrite ?varLRen_gType in *| progress (unfold up_ren, upRen_lType_lType, upRen_gType_gType, up_lType_lType, up_gType_gType in * )| progress (cbn [subst_lType subst_gType ren_lType ren_gType] in * )| fsimpl in *].
